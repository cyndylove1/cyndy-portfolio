      ...
      <div className='md:flex-row xl:mx-20 flex flex-col items-center justify-between pt-20 pb-32 mx-5'>
        <div className=''>
          <div className='' data-aos="fade-up" data-aos-delay="200">
            ...
            <a href="Nweke Cynthia Cv.pdf" download="NwekeCynthia_Cv.pdf"><button className='bg-blue transform-translate-y-14 hover:scale-110 px-4 py-2 mt-2 font-bold text-black transition duration-500 ease-in-out rounded-md'>Download Cv</button></a>
