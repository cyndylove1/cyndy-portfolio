    ...
    <div className="">
      ...
      <div className="h-fit xl:px-20 px-5 bg-black">
        ...
        <div className="lg:flex-row flex flex-col items-center justify-between pt-10 pb-32">
          ...
          <div
            className="flex justify-center lg:w-[50%] md:w-[70%] w-full"
            data-aos="fade-up"
            data-aos-delay="400"
          >
            <form ref={form} className="w-full" onSubmit={sendEmail}>
              <label htmlFor="first_name" className="text-[#fff]">
                First Name
              </label>
              <input
                type="text"
              ...
              <button
                type="submit"
                className="bg-blue px-6 py-2 mt-4 font-bold text-black transition duration-500 ease-in-out rounded-md"
              >
                Submit
              </button>
            </form>
