...
const Skill = () => {
  return (
    <div className="h-fit bg-black">
      <h2 className="text-blue py-4 pt-20 text-4xl font-extrabold text-center">
        Skills
      </h2>
      <div
      ...
      >
        <div className=" transform-translate-y-14 hover:scale-110 transition duration-500 ease-in-out">
          ...
          <h2 className="md:text-2xl pt-2 text-base font-bold text-white">
            HTML5
          </h2>
        </div>
        <div className="transform-translate-y-14 hover:scale-110 transition duration-500 ease-in-out">
          ...
          <h2 className="md:text-2xl ml-4 text-base font-bold text-white">
            CSS
          </h2>
        </div>
        <div className="transform-translate-y-14 hover:scale-110 transition duration-500 ease-in-out">
