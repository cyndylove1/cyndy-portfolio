...
const Projects = () => {
  return (
    <div className='bg-black'>
        <div>
            <h2 className="text-blue pt-20 text-4xl font-extrabold text-center">Projects</h2>
        </div>
        <div>
            <div className='md:grid-cols-2 xl:mx-20 grid grid-cols-1 gap-10 pt-10 pb-32 mx-5'>
                <div className=''>
                    ...
                    <div className=' text-white'>
                        <div className='flex justify-between mt-6' data-aos="fade-up" data-aos-duration="300">
                            <div className=''>
                                <h3 className='text-blue ml-1 text-2xl font-extrabold'>HeyWallet</h3>
                            </div>
                            <div className='mr-10'>
                                <a href="https://hey-app-cyan.vercel.app/"><h2 className='hover:text-blue text-xl transition duration-500 ease-in-out cursor-pointer'>View Live</h2></a>
                            </div>
                        </div>
                        <div>
                ...
                <div className="">
                    ...
                    <div className='flex justify-between mt-6 text-white'  data-aos="fade-up" data-aos-duration="300">
                        <div className=''>
                            <h3 className='text-blue ml-1 text-2xl font-extrabold'>Game Zone</h3>
                        </div>
                        <div>
                ...
                <div>
                    ...
                    <div className='flex justify-between mt-6 text-white'  data-aos="fade-up" data-aos-duration="300">
                        <div>
                            <h3 className='text-blue ml-1 text-2xl font-extrabold'>Antic</h3>
                        </div>
                        <div className="">
                ...
                <div className="">
                    ...
                    <div className='flex justify-between mt-6 text-white'  data-aos="fade-up" data-aos-duration="300">
                        <div>
                            <h3 className='text-blue ml-1 text-2xl font-extrabold'>Managing</h3>
                        </div>
                        <div className="">
